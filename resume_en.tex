...
\cvpersonalinfo{
    ...
    \cvdurationstyle {Go, Python software engineer}
...
\cvitem{
    ...
    Golang, C++, Python backend developer. I like to work on interesting projects, highly loaded systems.
    Supporter of competent architecture and friendly team =)
}
...
% Yandex middle
\cvitem{
        \cvdurationstyle{September 2022 - present}
    }{
        ...
        \begin{itemize}[leftmargin=*]
            \item I am engaged in the development of video scripts of the voice assistant Alice in smart devices. (C++, Kotlin)
        \end{itemize}
    }

% Yandex junior
\cvitem{
    \cvdurationstyle{September 2021 -- September 2022}
}{
    ...
    \begin{itemize}[leftmargin=*]
        \item Video scenarios development for smart speakers (with screen) and TV (C++)
    \end{itemize}
}
...
\cvitem{
    ...
    A language that once interested me became my favorite. I took an advanced development course in Yandex Praktikum, I write pet projects in my spare time in Go.
    \begin{itemize}
...
\cvitem{
    ...
    I use Python to solve some certain problems in which memory and time are not critical. Average skills.
    \begin{itemize}
