...
\cvitem{
    ...
    Golang, C++, Python software engineer.
    I create scalable and productive services for large RPS.
    I have experience with such technologies as databases (PostgreSQL, YDB); DevOps: containerization systems (Docker, Kubernetes), experience with cloud platforms (Yandex Cloud, AWS).
    Designed and implemented architectural solutions that allow applications to scale efficiently as the load grows.
}
