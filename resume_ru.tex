...
\cvitem{
    ...
    Backend-разработчик с навыками в Golang, C++ и Python.
    Создаю масштабируемые и производительные сервисы под большие RPS.
    Имею опыт работы с такими технологиями, как базы данных (PostgreSQL, YDB); DevOps: системы контейнеризации (Docker, Kubernetes), опыт работы с облачными платформами (Yandex Cloud, AWS).
    Проектировал и реализовывал архитектурные решения, которые позволяют приложениям эффективно масштабироваться по мере роста нагрузки.
}
